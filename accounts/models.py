...
class UserAccount(AbstractUser):
    ...
    profile_photo = models.ImageField(
        upload_to="image_profiles/", blank=True, null=True
    )
...
class VendorProfile(models.Model):
    user = models.OneToOneField(
        UserAccount, on_delete=models.CASCADE, related_name="vendor_profile"
    )
...
class AdminProfile(models.Model):
    user = models.OneToOneField(
        UserAccount, on_delete=models.CASCADE, related_name="admin_profile"
    )
